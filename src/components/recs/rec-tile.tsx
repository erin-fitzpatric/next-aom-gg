...
// This team splitting probably wants a better home. It could maybe be done once at parsetime and resolved after that
 ...
 * @returns array of two elements: the first containing the indexes of the teams that should be on the left,
 *          and the second containing the indexes of teams that should be on the right.
 */
function splitTeams(metadata: IRecordedGame): number[][]
{
